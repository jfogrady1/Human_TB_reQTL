...
Classical_Monocyte <- MASH("Classical_Monocyte")
Naïve_B_cell_mash <- MASH(celltype = "Naïve_B_cell")
memory_CD8_T_cell_mash <- MASH("Memory_CD8+_T_cell")
Non_classical_Monocyte <- MASH("Non-classical_Monocyte")
...
write.table(grid_data, file = '/home/workspace/jogrady/heQTL/results/Response_1/Source_Data/Fig_05A_grid_data.txt', sep = "\t", quote = FALSE, row.names = FALSE)
write.table(base_data, file = '/home/workspace/jogrady/heQTL/results/Response_1/Source_Data/Fig_05A_base_data.txt', sep = "\t", quote = FALSE, row.names = FALSE)
write.table(final_df, file = '/home/workspace/jogrady/heQTL/results/Response_1/Source_Data/Fig_05A.txt', sep = "\t", quote = FALSE, row.names = FALSE)
...
write.table(final_merged_df_signif, file = '/home/workspace/jogrady/heQTL/results/Response_1/Source_Data/Fig_05B.txt', sep = "\t", row.names = FALSE, quote = FALSE)
